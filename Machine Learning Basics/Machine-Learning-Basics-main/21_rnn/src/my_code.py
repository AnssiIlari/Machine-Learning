...
def create_RNN(input_shape, trainX, trainY):
    ...
    model.add(SimpleRNN(units=256, input_shape=input_shape, activation='tanh'))
    
    #model.add(Dropout(0.2)) # Testi
    ...
    model.fit(trainX, trainY, epochs=30, batch_size=16, verbose=1)
